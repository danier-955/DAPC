...
<div class="card">
	<div class="card-header bg-light-2">
		<h1 class="typography-headline">
			<i class="material-icons mr-1">local_parking</i> Editar programa
		</h1>
	</div>
	<div class="card-body">
		...
		<form method="post" action="{{ route('programas.update', $programa->id) }}" autocomplete="off">
			...
			<div class="form-row">
				<div class="form-group col-md-12">
			    	<label>Nombre</label>
			   		<input type="text" name="nomb_prog" class="form-control {{ $errors->has('nomb_prog') ? 'is-invalid' : '' }}" value="{{ old('nomb_prog', $programa->nomb_prog) }}" required autofocus>
			...
			<div class="form-row">
				<div class="form-group col-md-12">
			    	...
			    	<textarea name="desc_prog" rows="3" class="form-control {{ $errors->has('desc_prog') ? 'is-invalid' : '' }}" required autofocus>{{ old('desc_prog', $programa->desc_prog) }}</textarea>
