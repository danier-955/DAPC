		...
		<form method="post" action="{{ route('asignaturas.store') }}" autocomplete="off">
			...
			<div class="form-row">
			  	<div class="form-group col-md-12">
		    		...
		    		<textarea name="log1_asig" rows="3" class="form-control {{ $errors->has('log1_asig') ? 'is-invalid' : '' }}" autofocus>{{ old('log1_asig') }}</textarea>
			...
			<div class="form-row">
			  	<div class="form-group col-md-12">
		    		...
		    		<textarea name="log2_asig" rows="3" class="form-control {{ $errors->has('log2_asig') ? 'is-invalid' : '' }}" autofocus>{{ old('log2_asig') }}</textarea>
			...
			<div class="form-row">
			  	<div class="form-group col-md-12">
		    		...
		    		<textarea name="log3_asig" rows="3" class="form-control {{ $errors->has('log3_asig') ? 'is-invalid' : '' }}" autofocus>{{ old('log3_asig') }}</textarea>
			...
			<div class="form-row">
			  	<div class="form-group col-md-12">
		    		...
		    		<textarea name="log4_asig" rows="3" class="form-control {{ $errors->has('log4_asig') ? 'is-invalid' : '' }}" autofocus>{{ old('log4_asig') }}</textarea>
