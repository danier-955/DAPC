...
<div class="card">
	<div class="card-header bg-light-2">
		<h1 class="typography-headline">
			<i class="material-icons mr-1">font_download</i> Registrar area
		</h1>
	</div>
	<div class="card-body">
		...
		<form method="post" action="{{ route('areas.store') }}" autocomplete="off">
			...
			<div class="form-row">
		 		<div class="form-group col-md-12">
			    	...
			    	<textarea name="desc_area" rows="3" class="form-control {{ $errors->has('desc_area') ? 'is-invalid' : '' }}" required autofocus>{{ old('desc_area') }}</textarea>
