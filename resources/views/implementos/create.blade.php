@extends('layouts.app')
@section('title', 'Registrar útil escolar')
...
<div class="card">
	<div class="card-header bg-light-2">
  		<h1 class="typography-headline">
  			<i class="material-icons mr-1">brush</i> Registrar útil escolar
  		</h1>
  	</div>
	<div class="card-body">
			...
			<div class="form-row">
		  	...
		  	<div class="form-row">
		 		<div class="form-group col-md-12">
			    	...
			    	<textarea name="desc_util" rows="3" class="form-control {{ $errors->has('desc_util') ? 'is-invalid' : '' }}"  required autofocus>{{ old('desc_util') }}</textarea>
